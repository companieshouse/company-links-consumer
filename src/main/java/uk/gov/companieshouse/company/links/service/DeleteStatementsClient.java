...
public class DeleteStatementsClient implements LinkClient {
    ...
    public void patchLink(String companyNumber) {
        ...
        try {
            client.privateCompanyLinksResourceHandler().deletePscStatementsCompanyLink(String.format("/company/%s/links/persons-with-significant-control-statements/delete", companyNumber)).execute();
