...
public class DeleteExemptionsServiceTest {
    ...
    @InjectMocks
    private DeleteExemptionsService service;

    @Test
    @DisplayName("The service should call delete exemptions client with the correct company number")
    void process() {
        // given
